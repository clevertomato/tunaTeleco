  ...
  return (
    <div id='navBar' className={`${!showNav ? 'opacity-0' : 'opacity-100 '}  z-20  top-0 right-0 w-full transition-all ease-in-out delay-300 duration-500 absolute `}>
      <div className='hidden md:flex items-center justify-between w-full'>
        <div>
        <div className='text-md md:text-3xl lg:text-4xl 3xl:text-4xl text-black px-4 py-2 float-right transform transition-all duration-400 hover:cursor-pointer font-normal  rounded-sm ease-in-out border-y-3 border-white hover:border-my-orange hover:shadow-gray-400 hover:shadow-sm ml-4'>@TUNATELECO</div>
        </div>  
