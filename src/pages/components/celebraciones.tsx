...
export default function Celebraciones() {
  ...
  return (
    <div className={`${active ? 'ml--100' : ''}  h-quienes w-auto celebraciones-bg flex flex-col md:flex-row overflow-x-hidden transition-all ease-in-out delay-300 duration-500 `}>
        ...
        <div className='h-full w-full lg:w-4/6 sm:text-sm md:text-sm md3:text-base xl:text-xl 3xl:text-3xl flex flex-col justify-between relative'>
            <div className={`${active ? 'ml--100' : ''} h-full w-full px-8 2xl:pl-28 md:pr-0 md:py-8 lg:absolute z-10 flex flex-col justify-between transition-all ease-in-out delay-300 duration-500 `}>
        ...
        <div className='h-full py-8 px-8 md:pl-16 md:pr-28 md w-full lg:w-1/2 relative overflow-y-hidden overflow-x-auto'>
        <div className={`${active ? 'animate-changeBackground' : 'animate-changeBackground-not-active'} animated-background border-2 border-white rounded-sm h-70-screen relative`}>
                ...
                <div className="flex w-full h-full relative ">
                  <div className={`${active1 ? 'opacity-100 translate-item w-4/5 h-4/5 absolute z-10  ' : 'absolute z-0 '} ${active2 || active3 || active4 ? '' : ' '} background-item p-8 -m-2 w-1/2 h-1/2 flex flex-col bg-blue-200 border-2 border-white  transition-all ease-in-out delay-100 duration-400 hover:cursor-pointer overflow-y-hidden`}  onClick={clickActive1}>
