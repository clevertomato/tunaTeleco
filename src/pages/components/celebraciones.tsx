...
export default function Celebraciones() {
    ...
    const clickActive = () => {
        setActive(!active);
        boxServicios.current.scrollIntoView({ behavior: "smooth"})
      };
    const clickActive1 = () => {
      setActive1(!active1);
      setActive2(false);
