...
export default function Valores() {
  return (
    <div className='h-auto w-full backgroundfixed flex flex-col border-y-2 border-white gap-4 py-4 shadow-inset-y'>
        ...
        <div className='flex flex-wrap text-white h-3/5 relative justify-between'>
            <div className='w-1/2 md:w-1/4 h-auto flex flex-col p-8 gap-4 drop-shadow-lg'>
                <Image
                        ...
                        alt="logoupv"
                        height={100}
                        style={{ width:'auto', marginLeft: 'auto', marginRight: 'auto', filter: 'brightness(0) invert(1)'}}></Image>
