...
export default function Quesomos() {
  ...
  return (
    <div className='h-quienes w-auto quienes-bg flex flex-col md:flex-row overflow-x-hidden border-t-2 border-white'>
        <div className='h-full py-8 px-8 md:pl-28 md:pr-16 md w-full lg:w-1/2 relative'>
        ...
        <div className='h-full w-full lg:w-4/6 sm:text-sm md:text-sm md3:text-base xl:text-xl 3xl:text-2xl flex flex-col justify-between relative'>
            <div className='h-full w-full px-8 2xl:pr-28 md:pl-0 md:py-8 lg:absolute z-10 flex flex-col justify-between'>
            <Slide right duration={1500}><div className='md:border-right-top-right2 3xl:border-right-top-right h-full lg:h-5/6 grid place-content-center gap-4 md:gap-8 lg:gap-16 sm:w-full md:w-full text-center pb-4 md:pt-4 px-2 pr-4 3xl:px-4 text-quienes'>
...
<p className='grid place-content-center letter-spacing-011'>Reconocidos por su participación en eventos académicos, festivales culturales, su atuendo distintivo y su energía contagiosa, que los convierten en un símbolo de la tradición y avanguardia en Valencia.</p>
                ...
                <Slide right duration={1000}><div className='grid place-content-center md:-mt-2 pt-2 pb-8 md:py-0'>
