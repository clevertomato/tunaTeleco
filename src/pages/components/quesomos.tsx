...
export default function Quesomos() {
  ...
  return (
    <div className='h-quienes w-auto quienes-bg flex flex-col md:flex-row overflow-x-hidden border-t-2 border-white overflow-y-hidden'>
        ...
        <div className='h-auto md:h-full w-full lg:w-4/6 sm:text-sm md:text-sm md3:text-lg lg:text-xl 3xl:text-3xl flex flex-col relative overscroll-y-none'>
            <div className=' h-auto md:h-full w-full py-0 mt-0 px-8 md3:pr-28 md:pl-0 md:py-8 lg:absolute z-10 flex flex-col justify-between'>
