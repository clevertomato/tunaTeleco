...
export default function Quesomos() {
  ...
  return (
    <div className='h-quienes w-auto quienes-bg flex flex-col md:flex-row overflow-x-hidden border-t-2 border-white overflow-y-hidden '>
        ...
        <div className='hidden h-min md:h-full w-full lg:w-4/6 sm:text-sm md:text-sm md3:text-base lg:text-xl 3xl:text-3xl md2:flex flex-col relative overscroll-y-none'>
            ...
            <Slide right duration={1000}>
                <div className='md:border-right-top-right2 3xl:border-right-top-right h-full lg:h-5/6 grid place-content-center gap-4 md:gap-8 3xl:gap-16  sm:w-full md:w-full text-center pb-4 px-2 md3:px-6 md:p-8 3xl:px-16 text-quienes'>
