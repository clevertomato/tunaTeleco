...
function Apuntate() {
  return (
    <div className='h-auto w-full  border-t-2 border-white'>
        <div className='h-min md:h-full w-full flex md:flex-row flex-col gap-4 md:gap-0 '>
            ...
            <div className='h-min md:h-full w-full md:w-1/2 flex flex-col md:justify-between gap-8 form-bg'>
              ...
              <div className='h-2/6 grid place-content-center px-8  md:px-16'>
               <p className=' text-black text-lg text-center '>Si tienes pasión por la música, ansías explorar nuevos horizontes, disfrutas de las aventuras y buscas la oportunidad de conocer personas increíbles, entonces este es el lugar para ti. Forma parte de nuestra Tuna Universitaria y descubre las emocionantes experiencias que te aguardan. No dudes más, ¡es hora de unirte a nosotros!</p>
              </div>
